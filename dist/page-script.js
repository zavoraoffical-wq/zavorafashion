...
const EXPANDED_REAL_PRINTFUL_CATALOG = [
  ...
  { id: 'PF-W-07', printfulId: '288B', name: 'Zavora Women Oversized Streetwear Tee', title: 'Zavora Women Oversized Streetwear Tee', category: 'oversized-tees', gender: 'women', price: 54.89, originalPrice: 84.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://files.cdn.printful.com/products/288/product_1578393510.jpg', badge: 'NEW', collection: ['streetwear'] },
  { id: 'PF-W-08', printfulId: '456B', name: 'Zavora Luxury Cropped Hoodie', title: 'Zavora Luxury Cropped Hoodie', category: 'cropped-hoodies', gender: 'women', price: 92.89, originalPrice: 144.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://files.cdn.printful.com/products/456/product_1598285510.jpg', badge: 'POPULAR', collection: ['streetwear'] },
  { id: 'PF-W-09', printfulId: '512B', name: 'Zavora Cropped Baby Rib Tee', title: 'Zavora Cropped Baby Rib Tee', category: 'baby-tees', gender: 'women', price: 46.89, originalPrice: 72.99, rating: 4.8, colors: ['white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://files.cdn.printful.com/products/512/product_1615801509.jpg', badge: null, collection: ['streetwear'] },
  { id: 'PF-W-10', printfulId: '490W', name: 'Zavora Studio Wide-Leg Fleece Sweatpants', title: 'Zavora Studio Wide-Leg Fleece Sweatpants', category: 'sweatpants', gender: 'women', price: 88.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://files.cdn.printful.com/products/490/product_1615801209.jpg', badge: 'BESTSELLER', collection: ['streetwear'] },
  ...
  { id: 'PF-M-10', printfulId: '430', name: 'Unisex Athletic Shorts | Champion 8180', title: 'Unisex Athletic Shorts | Champion 8180', category: 'shorts', gender: 'men', price: 58.89, originalPrice: 89.99, rating: 4.7, colors: ['black', 'gray', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://files.cdn.printful.com/products/430/product_1578393900.jpg', badge: null, collection: ['beachwear', 'sportswear'] },
