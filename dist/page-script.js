...
const EXPANDED_REAL_PRINTFUL_CATALOG = [
  // WOMENSWEAR APPAREL
  { id: 'PF-W-01', printfulId: '288', name: 'Women\'s Relaxed T-Shirt | Bella + Canvas 6400', title: 'Women\'s Relaxed T-Shirt | Bella + Canvas 6400', category: 'oversized-tees', gender: 'women', price: 49.89, originalPrice: 79.99, rating: 4.8, colors: ['black', 'white', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'best'] },
  { id: 'PF-W-02', printfulId: '512', name: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', title: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', category: 'baby-tees', gender: 'women', price: 44.89, originalPrice: 69.99, rating: 4.9, colors: ['black', 'white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear', 'new'] },
  ...
  { id: 'PF-W-07', printfulId: '288B', name: 'Zavora Women Oversized Streetwear Tee', title: 'Zavora Women Oversized Streetwear Tee', category: 'oversized-tees', gender: 'women', price: 54.89, originalPrice: 84.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear'] },
  ...
  { id: 'PF-W-09', printfulId: '512B', name: 'Zavora Cropped Baby Rib Tee', title: 'Zavora Cropped Baby Rib Tee', category: 'baby-tees', gender: 'women', price: 46.89, originalPrice: 72.99, rating: 4.8, colors: ['white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['streetwear'] },
