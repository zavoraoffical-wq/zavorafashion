...
const EXPANDED_REAL_PRINTFUL_CATALOG = [
  // WOMENSWEAR APPAREL
  { id: 'PF-W-01', printfulId: '288', name: 'Women\'s Relaxed T-Shirt | Bella + Canvas 6400', title: 'Women\'s Relaxed T-Shirt | Bella + Canvas 6400', category: 'oversized-tees', gender: 'women', price: 49.89, originalPrice: 79.99, rating: 4.8, colors: ['black', 'white', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'best'] },
  { id: 'PF-W-02', printfulId: '512', name: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', title: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', category: 'baby-tees', gender: 'women', price: 44.89, originalPrice: 69.99, rating: 4.9, colors: ['black', 'white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear', 'new'] },
  { id: 'PF-W-03', printfulId: '456', name: 'Women\'s Fleece Crop Hoodie | Bella + Canvas 7502', title: 'Women\'s Fleece Crop Hoodie | Bella + Canvas 7502', category: 'cropped-hoodies', gender: 'women', price: 89.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'gray', 'gold'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear'] },
  { id: 'PF-W-04', printfulId: '416', name: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', title: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', category: 'hoodies', gender: 'women', price: 104.89, originalPrice: 164.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'ORGANIC', collection: ['streetwear'] },
  { id: 'PF-W-05', printfulId: '518', name: 'Women\'s High-Waisted Fleece Sweatpants', title: 'Women\'s High-Waisted Fleece Sweatpants', category: 'sweatpants', gender: 'women', price: 84.89, originalPrice: 134.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'COZY', collection: ['streetwear', 'matching-sets'] },
  { id: 'PF-W-06', printfulId: '472', name: 'Women\'s Tailored Denim Jacket | Threadfast 370J', title: 'Women\'s Tailored Denim Jacket | Threadfast 370J', category: 'jackets', gender: 'women', price: 148.89, originalPrice: 219.99, rating: 4.9, colors: ['blue', 'black'], sizes: ['S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', badge: 'PREMIUM', collection: ['streetwear'] },
  { id: 'PF-W-07', printfulId: '288B', name: 'Zavora Women Oversized Streetwear Tee', title: 'Zavora Women Oversized Streetwear Tee', category: 'oversized-tees', gender: 'women', price: 54.89, originalPrice: 84.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear'] },
  { id: 'PF-W-08', printfulId: '456B', name: 'Zavora Luxury Cropped Hoodie', title: 'Zavora Luxury Cropped Hoodie', category: 'cropped-hoodies', gender: 'women', price: 92.89, originalPrice: 144.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'POPULAR', collection: ['streetwear'] },
  { id: 'PF-W-09', printfulId: '512B', name: 'Zavora Cropped Baby Rib Tee', title: 'Zavora Cropped Baby Rib Tee', category: 'baby-tees', gender: 'women', price: 46.89, originalPrice: 72.99, rating: 4.8, colors: ['white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['streetwear'] },
  { id: 'PF-W-10', printfulId: '490W', name: 'Zavora Studio Wide-Leg Fleece Sweatpants', title: 'Zavora Studio Wide-Leg Fleece Sweatpants', category: 'sweatpants', gender: 'women', price: 88.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear'] },
  { id: 'PF-W-11', printfulId: '354', name: 'All-Over Print Unisex Wide-Leg Pants / Leggings', title: 'All-Over Print Unisex Wide-Leg Pants / Leggings', category: 'sweatpants', gender: 'women', price: 94.89, originalPrice: 149.99, rating: 4.9, colors: ['black', 'white', 'gray'], sizes: ['XS', 'S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'best'] },
  { id: 'PF-W-12', printfulId: '490L', name: 'Women\'s Premium High-Waisted Yoga Leggings', title: 'Women\'s Premium High-Waisted Yoga Leggings', category: 'sweatpants', gender: 'women', price: 89.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear', 'matching-sets'] },

  // MENSWEAR APPAREL
  { id: 'PF-M-01', printfulId: '262', name: 'Unisex Staple T-Shirt | Bella + Canvas 3001', title: 'Unisex Staple T-Shirt | Bella + Canvas 3001', category: 'oversized-tees', gender: 'men', price: 54.89, originalPrice: 89.99, rating: 4.8, colors: ['black', 'white', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'best'] },
  { id: 'PF-M-02', printfulId: '384', name: 'Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500', title: 'Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500', category: 'hoodies', gender: 'men', price: 94.89, originalPrice: 149.99, rating: 4.9, colors: ['black', 'white', 'gray', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'POPULAR', collection: ['streetwear', 'best'] },
  { id: 'PF-M-03', printfulId: '480', name: 'Unisex Heavyweight T-Shirt | Comfort Colors 1717', title: 'Unisex Heavyweight T-Shirt | Comfort Colors 1717', category: 'heavyweight-tees', gender: 'men', price: 64.89, originalPrice: 99.99, rating: 4.9, colors: ['black', 'green', 'gold'], sizes: ['M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1490578474895-699bc4e2cf59?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear', 'new'] },
  { id: 'PF-M-04', printfulId: '444', name: 'Unisex Premium Pullover Hoodie | Cotton Heritage M2580', title: 'Unisex Premium Pullover Hoodie | Cotton Heritage M2580', category: 'hoodies', gender: 'men', price: 114.89, originalPrice: 179.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'LUXURY', collection: ['streetwear', 'best'] },
  { id: 'PF-M-05', printfulId: '312', name: 'Unisex Fleece Zip Hoodie | Bella + Canvas 3939', title: 'Unisex Fleece Zip Hoodie | Bella + Canvas 3939', category: 'zip-hoodies', gender: 'men', price: 98.89, originalPrice: 159.99, rating: 4.7, colors: ['black', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear'] },
  { id: 'PF-M-06', printfulId: '382', name: 'Unisex Crewneck Sweatshirt | Gildan 18000', title: 'Unisex Crewneck Sweatshirt | Gildan 18000', category: 'sweatshirts', gender: 'men', price: 84.89, originalPrice: 139.99, rating: 4.8, colors: ['black', 'white', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['streetwear'] },
  { id: 'PF-M-07', printfulId: '490', name: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', title: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', category: 'sweatpants', gender: 'men', price: 89.89, originalPrice: 144.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'matching-sets'] },
  { id: 'PF-M-08', printfulId: '422', name: 'Unisex Champion Track Pants | Champion P800', title: 'Unisex Champion Track Pants | Champion P800', category: 'cargo-pants', gender: 'men', price: 104.89, originalPrice: 169.99, rating: 4.9, colors: ['black', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: 'LIMITED', collection: ['sportswear', 'limited'] },
  { id: 'PF-M-09', printfulId: '468', name: 'Unisex Champion Bomber Jacket | Champion MA-1', title: 'Unisex Champion Bomber Jacket | Champion MA-1', category: 'jackets', gender: 'men', price: 168.89, originalPrice: 249.99, rating: 4.9, colors: ['black', 'green'], sizes: ['M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', badge: 'PREMIUM', collection: ['streetwear'] },
  { id: 'PF-M-10', printfulId: '430', name: 'Unisex Athletic Shorts | Champion 8180', title: 'Unisex Athletic Shorts | Champion 8180', category: 'shorts', gender: 'men', price: 58.89, originalPrice: 89.99, rating: 4.7, colors: ['black', 'gray', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['beachwear', 'sportswear'] },

  // ACCESSORIES
  { id: 'PF-A-01', printfulId: '638', name: 'Zavora Embroidered Dad Cap | Yupoong 6245CM', title: 'Zavora Embroidered Dad Cap | Yupoong 6245CM', category: 'accessories', gender: 'unisex', price: 42.89, originalPrice: 64.99, rating: 4.9, colors: ['black', 'white'], sizes: ['ONE SIZE'], img: 'assets/zavora-dad-hat.png', badge: 'BESTSELLER', collection: ['accessories', 'summer-hats-bags'] }
];

function generateExpandedApparelCatalog(gender = 'all') {
  if (gender === 'men') {
    return EXPANDED_REAL_PRINTFUL_CATALOG.filter(p => p.gender === 'men' || p.gender === 'unisex');
  }
  if (gender === 'women') {
    return EXPANDED_REAL_PRINTFUL_CATALOG.filter(p => p.gender === 'women' || p.gender === 'unisex');
  }
  return EXPANDED_REAL_PRINTFUL_CATALOG;
}
