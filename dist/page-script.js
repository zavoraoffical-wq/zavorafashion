...
const EXPANDED_REAL_PRINTFUL_CATALOG = [
  ...
  { id: 'PF-W-02', printfulId: '512', name: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', title: 'Women\'s Baby Rib Crop Tee | Bella + Canvas 1010', category: 'baby-tees', gender: 'women', price: 44.89, originalPrice: 69.99, rating: 4.9, colors: ['black', 'white', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&w=800&q=80', badge: 'NEW', collection: ['streetwear', 'new'] },
  ...
  { id: 'PF-W-04', printfulId: '416', name: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', title: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', category: 'hoodies', gender: 'women', price: 104.89, originalPrice: 164.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'ORGANIC', collection: ['streetwear'] },
  ...
  { id: 'PF-M-07', printfulId: '490', name: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', title: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', category: 'sweatpants', gender: 'men', price: 89.89, originalPrice: 144.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'assets/studio-wide-trouser.png', badge: 'BESTSELLER', collection: ['streetwear', 'matching-sets'] },
  { id: 'PF-M-08', printfulId: '422', name: 'Unisex Champion Track Pants | Champion P800', title: 'Unisex Champion Track Pants | Champion P800', category: 'cargo-pants', gender: 'men', price: 104.89, originalPrice: 169.99, rating: 4.9, colors: ['black', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'assets/studio-wide-trouser.png', badge: 'LIMITED', collection: ['sportswear', 'limited'] },
