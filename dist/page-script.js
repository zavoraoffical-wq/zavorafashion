...
const REAL_PRINTFUL_APPAREL_CATALOG = [
  { id: 'PF-W-01', printfulId: '288', name: "Zavora Women's Relaxed Streetwear Tee", category: 'oversized-tees', gender: 'women', price: 49.89, img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'new'], badge: 'BESTSELLER', popularity: 98 },
  { id: 'PF-W-02', printfulId: '512', name: "Zavora Women's Baby Rib Crop Tee", category: 'baby-tees', gender: 'women', price: 44.89, img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'NEW', popularity: 95 },
  { id: 'PF-W-03', printfulId: '456', name: "Zavora Women's Fleece Crop Hoodie", category: 'cropped-hoodies', gender: 'women', price: 89.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'trending'], badge: 'TRENDING', popularity: 96 },
  { id: 'PF-W-04', printfulId: '416', name: "Zavora Women's Organic Raglan Hoodie", category: 'hoodies', gender: 'women', price: 104.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'ORGANIC', popularity: 92 },
  { id: 'PF-W-05', printfulId: '518', name: "Zavora Women's High-Waisted Fleece Sweatpants", category: 'sweatpants', gender: 'women', price: 84.89, img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'matching-sets', 'best'], badge: 'COZY', popularity: 94 },
  { id: 'PF-W-06', printfulId: '472', name: "Zavora Women's Tailored Denim Jacket", category: 'jackets', gender: 'women', price: 148.89, img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'PREMIUM', popularity: 91 },
  { id: 'PF-M-01', printfulId: '262', name: 'Zavora Unisex Staple Streetwear Tee', category: 'oversized-tees', gender: 'men', price: 54.89, img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'new'], badge: 'BESTSELLER', popularity: 99 },
  { id: 'PF-M-02', printfulId: '384', name: 'Zavora Unisex Heavy Blend Hoodie', category: 'hoodies', gender: 'men', price: 94.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best'], badge: 'POPULAR', popularity: 97 },
  { id: 'PF-M-03', printfulId: '480', name: 'Zavora Heavyweight Vintage T-Shirt', category: 'heavyweight-tees', gender: 'men', price: 64.89, img: 'https://images.unsplash.com/photo-1490578474895-699bc4e2cf59?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'NEW', popularity: 89 },
  { id: 'PF-M-04', printfulId: '444', name: 'Zavora Luxury Pullover Hoodie', category: 'hoodies', gender: 'men', price: 114.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best'], badge: 'LUXURY', popularity: 95 },
  { id: 'PF-M-05', printfulId: '312', name: 'Zavora Fleece Zip Hoodie', category: 'zip-hoodies', gender: 'men', price: 98.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'TRENDING', popularity: 90 },
  { id: 'PF-M-06', printfulId: '382', name: 'Zavora Crewneck Sweatshirt', category: 'sweatshirts', gender: 'men', price: 84.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear'], badge: 'CLASSIC', popularity: 88 },
  { id: 'PF-M-07', printfulId: '490', name: 'Zavora Heavyweight Streetwear Sweatpants', category: 'sweatpants', gender: 'men', price: 89.89, img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'matching-sets'], badge: 'BESTSELLER', popularity: 93 },
  { id: 'PF-M-09', printfulId: '468', name: 'Zavora Champion Bomber Jacket', category: 'jackets', gender: 'men', price: 168.89, img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'PREMIUM', popularity: 96 },
  { id: 'PF-A-01', printfulId: '638', name: 'Zavora Embroidered Dad Cap', category: 'accessories', gender: 'unisex', price: 42.89, img: 'assets/zavora-dad-hat.png', collection: ['accessories', 'summer-hats-bags', 'best'], badge: 'BESTSELLER', popularity: 94 },
  { id: 'PF-A-02', printfulId: '458', name: 'Zavora Studio Cuffed Beanie', category: 'accessories', gender: 'unisex', price: 34.89, img: 'assets/studio-wide-trouser.png', collection: ['accessories'], badge: 'WARM', popularity: 87 }
];
