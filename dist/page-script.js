...
const EXPANDED_REAL_PRINTFUL_CATALOG = [
  ...
  { id: 'PF-W-03', printfulId: '456', name: 'Women\'s Fleece Crop Hoodie | Bella + Canvas 7502', title: 'Women\'s Fleece Crop Hoodie | Bella + Canvas 7502', category: 'cropped-hoodies', gender: 'women', price: 89.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'gray', 'gold'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear'] },
  { id: 'PF-W-04', printfulId: '416', name: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', title: 'Women\'s Organic Raglan Hoodie | Stanley/Stella STSU822', category: 'hoodies', gender: 'women', price: 104.89, originalPrice: 164.99, rating: 4.8, colors: ['black', 'white'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'ORGANIC', collection: ['streetwear'] },
  { id: 'PF-W-05', printfulId: '518', name: 'Women\'s High-Waisted Fleece Sweatpants', title: 'Women\'s High-Waisted Fleece Sweatpants', category: 'sweatpants', gender: 'women', price: 84.89, originalPrice: 134.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'COZY', collection: ['streetwear', 'matching-sets'] },
  ...
  { id: 'PF-W-08', printfulId: '456B', name: 'Zavora Luxury Cropped Hoodie', title: 'Zavora Luxury Cropped Hoodie', category: 'cropped-hoodies', gender: 'women', price: 92.89, originalPrice: 144.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'POPULAR', collection: ['streetwear'] },
  ...
  { id: 'PF-W-10', printfulId: '490W', name: 'Zavora Studio Wide-Leg Fleece Sweatpants', title: 'Zavora Studio Wide-Leg Fleece Sweatpants', category: 'sweatpants', gender: 'women', price: 88.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'gray'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear'] },
  { id: 'PF-W-11', printfulId: '354', name: 'All-Over Print Unisex Wide-Leg Pants / Leggings', title: 'All-Over Print Unisex Wide-Leg Pants / Leggings', category: 'sweatpants', gender: 'women', price: 94.89, originalPrice: 149.99, rating: 4.9, colors: ['black', 'white', 'gray'], sizes: ['XS', 'S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'best'] },
  { id: 'PF-W-12', printfulId: '490L', name: 'Women\'s Premium High-Waisted Yoga Leggings', title: 'Women\'s Premium High-Waisted Yoga Leggings', category: 'sweatpants', gender: 'women', price: 89.89, originalPrice: 139.99, rating: 4.9, colors: ['black', 'blue'], sizes: ['XS', 'S', 'M', 'L'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear', 'matching-sets'] },
  ...
  { id: 'PF-M-02', printfulId: '384', name: 'Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500', title: 'Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500', category: 'hoodies', gender: 'men', price: 94.89, originalPrice: 149.99, rating: 4.9, colors: ['black', 'white', 'gray', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'POPULAR', collection: ['streetwear', 'best'] },
  ...
  { id: 'PF-M-04', printfulId: '444', name: 'Unisex Premium Pullover Hoodie | Cotton Heritage M2580', title: 'Unisex Premium Pullover Hoodie | Cotton Heritage M2580', category: 'hoodies', gender: 'men', price: 114.89, originalPrice: 179.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'LUXURY', collection: ['streetwear', 'best'] },
  { id: 'PF-M-05', printfulId: '312', name: 'Unisex Fleece Zip Hoodie | Bella + Canvas 3939', title: 'Unisex Fleece Zip Hoodie | Bella + Canvas 3939', category: 'zip-hoodies', gender: 'men', price: 98.89, originalPrice: 159.99, rating: 4.7, colors: ['black', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: 'TRENDING', collection: ['streetwear'] },
  { id: 'PF-M-06', printfulId: '382', name: 'Unisex Crewneck Sweatshirt | Gildan 18000', title: 'Unisex Crewneck Sweatshirt | Gildan 18000', category: 'sweatshirts', gender: 'men', price: 84.89, originalPrice: 139.99, rating: 4.8, colors: ['black', 'white', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['streetwear'] },
  { id: 'PF-M-07', printfulId: '490', name: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', title: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', category: 'sweatpants', gender: 'men', price: 89.89, originalPrice: 144.99, rating: 4.8, colors: ['black', 'gray'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'BESTSELLER', collection: ['streetwear', 'matching-sets'] },
  { id: 'PF-M-08', printfulId: '422', name: 'Unisex Champion Track Pants | Champion P800', title: 'Unisex Champion Track Pants | Champion P800', category: 'cargo-pants', gender: 'men', price: 104.89, originalPrice: 169.99, rating: 4.9, colors: ['black', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: 'LIMITED', collection: ['sportswear', 'limited'] },
  ...
  { id: 'PF-M-10', printfulId: '430', name: 'Unisex Athletic Shorts | Champion 8180', title: 'Unisex Athletic Shorts | Champion 8180', category: 'shorts', gender: 'men', price: 58.89, originalPrice: 89.99, rating: 4.7, colors: ['black', 'gray', 'blue'], sizes: ['S', 'M', 'L', 'XL'], img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', badge: null, collection: ['beachwear', 'sportswear'] },
