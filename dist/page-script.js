...
const REAL_PRINTFUL_APPAREL_CATALOG = [
  { id: 'PF-W-01', printfulId: '288', name: "Women's Relaxed T-Shirt | Bella + Canvas 6400", category: 'oversized-tees', gender: 'women', price: 49.89, img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'new'], badge: 'BESTSELLER', popularity: 98 },
  { id: 'PF-W-02', printfulId: '512', name: "Women's Baby Rib Crop Tee | Bella + Canvas 1010", category: 'baby-tees', gender: 'women', price: 44.89, img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'NEW', popularity: 95 },
  { id: 'PF-W-03', printfulId: '456', name: "Women's Fleece Crop Hoodie | Bella + Canvas 7502", category: 'cropped-hoodies', gender: 'women', price: 89.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'trending'], badge: 'TRENDING', popularity: 96 },
  { id: 'PF-W-04', printfulId: '416', name: "Women's Organic Raglan Hoodie | Stanley/Stella STSU822", category: 'hoodies', gender: 'women', price: 104.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'ORGANIC', popularity: 92 },
  { id: 'PF-W-05', printfulId: '518', name: "Women's High-Waisted Fleece Sweatpants", category: 'sweatpants', gender: 'women', price: 84.89, img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'matching-sets', 'best'], badge: 'COZY', popularity: 94 },
  { id: 'PF-W-06', printfulId: '472', name: "Women's Tailored Denim Jacket | Threadfast 370J", category: 'jackets', gender: 'women', price: 148.89, img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'PREMIUM', popularity: 91 },
  { id: 'PF-M-01', printfulId: '262', name: 'Unisex Staple T-Shirt | Bella + Canvas 3001', category: 'oversized-tees', gender: 'men', price: 54.89, img: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best', 'new'], badge: 'BESTSELLER', popularity: 99 },
  { id: 'PF-M-02', printfulId: '384', name: 'Unisex Heavy Blend Hooded Sweatshirt | Gildan 18500', category: 'hoodies', gender: 'men', price: 94.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best'], badge: 'POPULAR', popularity: 97 },
  { id: 'PF-M-03', printfulId: '480', name: 'Unisex Heavyweight T-Shirt | Comfort Colors 1717', category: 'heavyweight-tees', gender: 'men', price: 64.89, img: 'https://images.unsplash.com/photo-1490578474895-699bc4e2cf59?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'new'], badge: 'NEW', popularity: 89 },
  { id: 'PF-M-04', printfulId: '444', name: 'Unisex Premium Pullover Hoodie | Cotton Heritage M2580', category: 'hoodies', gender: 'men', price: 114.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'best'], badge: 'LUXURY', popularity: 95 },
  { id: 'PF-M-05', printfulId: '312', name: 'Unisex Fleece Zip Hoodie | Bella + Canvas 3939', category: 'zip-hoodies', gender: 'men', price: 98.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'TRENDING', popularity: 90 },
  { id: 'PF-M-06', printfulId: '382', name: 'Unisex Crewneck Sweatshirt | Gildan 18000', category: 'sweatshirts', gender: 'men', price: 84.89, img: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=800&q=80', collection: ['streetwear'], badge: 'CLASSIC', popularity: 88 },
  { id: 'PF-M-07', printfulId: '490', name: 'Unisex Heavyweight Sweatpants | Cotton Heritage M7450', category: 'sweatpants', gender: 'men', price: 89.89, img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'matching-sets'], badge: 'BESTSELLER', popularity: 93 },
  { id: 'PF-M-09', printfulId: '468', name: 'Unisex Champion Bomber Jacket | Champion MA-1', category: 'jackets', gender: 'men', price: 168.89, img: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80', collection: ['streetwear', 'trending'], badge: 'PREMIUM', popularity: 96 },
  { id: 'PF-A-01', printfulId: '638', name: 'Zavora Embroidered Dad Cap | Yupoong 6245CM', category: 'accessories', gender: 'unisex', price: 42.89, img: 'assets/zavora-dad-hat.png', collection: ['accessories', 'summer-hats-bags', 'best'], badge: 'BESTSELLER', popularity: 94 },
  { id: 'PF-A-02', printfulId: '458', name: 'Zavora Cuffed Beanie | Yupoong 1501', category: 'accessories', gender: 'unisex', price: 34.89, img: 'assets/studio-wide-trouser.png', collection: ['accessories'], badge: 'WARM', popularity: 87 }
];
...
function generateExpandedApparelCatalog(gender = 'all') {
  ...
  const source = deduplicateProducts([...admin, ...EXPANDED_REAL_PRINTFUL_CATALOG]);
  if (gender === 'men') {
    return source.filter(p => p.gender === 'men' || p.gender === 'unisex');
  }
  if (gender === 'women') {
    return source.filter(p => p.gender === 'women' || p.gender === 'unisex');
  }
  return source;
}
