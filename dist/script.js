...
// STOREFRONT_APPAREL_CATALOG — empty: only admin-added products show on website
...
function getHomeProducts() {
  ...
  // Only show admin-published products + any printful products loaded from DB
  const rawList = uniqueHomeProducts([...adminProducts, ...state.printfulProducts]);
  return rawList
