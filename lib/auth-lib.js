...
async function db() {
  ...
  if (!uri) {
    ...
    throw new Error('Missing database connection. Add MONGODB_URI, SUPABASE_URL plus SUPABASE_SERVICE_ROLE_KEY/SUPABASE_ANON_KEY, or Vercel Supabase POSTGRES_URL/POSTGRES_PRISMA_URL.');
  }
