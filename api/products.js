...
const REAL_PRINTFUL_IMPORTED_PRODUCTS = [
  ...
  },
  {
    ...
    categoryPath: 'Unisex > Sweatshirts',
    gender: 'Unisex',
  ...
  },
  {
    ...
    images: ['https://files.cdn.printful.com/products/512/13444_1638362629.jpg'],
    stock: 12,
    sku: 'PF-512-WHITE-M',
  ...
  },
  {
    ...
    categoryPath: 'Unisex > Accessories',
    gender: 'Unisex',
    productType: 'Hat',
    ...
    images: ['https://files.cdn.printful.com/products/205/7604_1583236021.jpg'],
    stock: 15,
    sku: 'PF-205-BLACK-OS',
